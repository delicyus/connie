<?php
// SOLUTION 3 : On ajoute une fonction pour que wp_mail traite le HTML
// A placer apres la function courrielEnvoyer()
...
//         // body de l'email
//         $the_body_html .= nl2br("Sent by: " . $inputs['courriel'] . "\r\n");
//         $the_body_html .= nl2br("Message: \r\n" . $inputs['message']);
